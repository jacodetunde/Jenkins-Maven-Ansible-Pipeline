...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.52.94:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-jacodetunde', //update and provide your channel name
